...
// This code has the add, edit and delete functions for the student table
	...
	if (isset($_POST['addRecord'])){
		// Create the web form
		echo '
			<form method="post" action="SQLStudentClasses.php">
				Row ID: <input type="number" name="ID"><br><br>
	...
	if (isset($_POST['editRecord'])){
		...
		if (empty($_POST['selectBox'])) {
			...
			echo '
				<form method="post" action="SQLStudentClasses.php">
					Row ID: <input type="number" name="ID" value="'.$ID.'"><br><br>
