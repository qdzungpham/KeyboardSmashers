...
CREATE TABLE `students` (
  ...
  `preferredGender` enum('Male','Female') DEFAULT NULL,
  PRIMARY KEY (`studentID`)
...
INSERT INTO `students` VALUES (1,'Tom','Santos','Male','1995-07-12','39 main St','Sunnybank','QLD','4012','tomsantos@gmail.com',NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO `teachers` VALUES (1,'bob','bobby','Male','1983-02-15','Graduated','bob.bobby@gmail.com',NULL,NULL,'Piano','English, Spanish',NULL,'Great teacher');
...
-- Dump completed on 2016-09-23 11:04:43
